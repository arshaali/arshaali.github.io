...
The entirety of this work is documented in my [PhD thesis](https://deepblue.lib.umich.edu/handle/2027.42/197186). The experiment on shared mental models, communication, and team situation awareness is published in an [IEEE Access journal paper](https://ieeexplore.ieee.org/document/11346936). The situation awareness estimator is published in a [IEEE RO-MAN conference paper](https://ieeexplore.ieee.org/document/11217621). Other journal and conference papers from these projects are currently under review.
